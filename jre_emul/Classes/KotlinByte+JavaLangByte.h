...
/*!
 ...
 - seealso: java.lang.Byte#parseByte(java.lang.String, int)
 */
+ (CommonByte * __nonnull)decodeWithNSString:(NSString *)nm;
...
/*!
 ...
 @since 1.5
 */
+ (CommonByte * __nonnull)valueOfWithByte:(jbyte)b;
...
J2OBJC_STATIC_INIT(CommonByte)

/*!
 @brief A constant holding the minimum value a <code>byte</code> can
  have, -2<sup>7</sup>.
 */
inline jbyte CommonByte_get_MIN_VALUE(void);
#define CommonByte_MIN_VALUE -128
J2OBJC_STATIC_FIELD_CONSTANT(CommonByte, MIN_VALUE, jbyte)

/*!
 @brief A constant holding the maximum value a <code>byte</code> can
  have, 2<sup>7</sup>-1.
 */
inline jbyte CommonByte_get_MAX_VALUE(void);
#define CommonByte_MAX_VALUE 127
...
FOUNDATION_EXPORT IOSClass *CommonByte_TYPE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonByte, TYPE, IOSClass *)
...
/*!
 ...
 @since 1.5
 */
inline jint CommonByte_get_SIZE(void);
#define CommonByte_SIZE 8
J2OBJC_STATIC_FIELD_CONSTANT(CommonByte, SIZE, jint)
...
/*!
 ...
 @since 1.8
 */
inline jint CommonByte_get_BYTES(void);
#define CommonByte_BYTES 1
J2OBJC_STATIC_FIELD_CONSTANT(CommonByte, BYTES, jint)

FOUNDATION_EXPORT NSString *CommonByte_toStringWithByte_(jbyte b);

FOUNDATION_EXPORT CommonByte *CommonByte_valueOfWithByte_(jbyte b);

FOUNDATION_EXPORT jbyte CommonByte_parseByteWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT jbyte CommonByte_parseByteWithNSString_(NSString *s);

FOUNDATION_EXPORT CommonByte *CommonByte_valueOfWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT CommonByte *CommonByte_valueOfWithNSString_(NSString *s);
...
FOUNDATION_EXPORT CommonByte *create_CommonByte_initWithNSString_(NSString *s);

FOUNDATION_EXPORT jint CommonByte_hashCodeWithByte_(jbyte value);
...
FOUNDATION_EXPORT NSString *CommonByte_toHexStringWithByte_withBoolean_(jbyte b, jboolean upperCase);

J2OBJC_TYPE_LITERAL_HEADER(CommonByte)
