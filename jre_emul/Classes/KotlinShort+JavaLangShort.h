...
J2OBJC_STATIC_INIT(CommonShort)

/*!
 @brief A constant holding the minimum value a <code>short</code> can
  have, -2<sup>15</sup>.
 */
inline jshort CommonShort_get_MIN_VALUE(void);
#define CommonShort_MIN_VALUE -32768
J2OBJC_STATIC_FIELD_CONSTANT(CommonShort, MIN_VALUE, jshort)

/*!
 @brief A constant holding the maximum value a <code>short</code> can
  have, 2<sup>15</sup>-1.
 */
inline jshort CommonShort_get_MAX_VALUE(void);
#define CommonShort_MAX_VALUE 32767
...
FOUNDATION_EXPORT IOSClass *CommonShort_TYPE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonShort, TYPE, IOSClass *)
...
/*!
 ...
 @since 1.5
 */
inline jint CommonShort_get_SIZE(void);
#define CommonShort_SIZE 16
J2OBJC_STATIC_FIELD_CONSTANT(CommonShort, SIZE, jint)
...
/*!
 ...
 @since 1.8
 */
inline jint CommonShort_get_BYTES(void);
#define CommonShort_BYTES 2
J2OBJC_STATIC_FIELD_CONSTANT(CommonShort, BYTES, jint)

FOUNDATION_EXPORT NSString *CommonShort_toStringWithShort_(jshort s);

FOUNDATION_EXPORT jshort CommonShort_parseShortWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT jshort CommonShort_parseShortWithNSString_(NSString *s);

FOUNDATION_EXPORT CommonShort *CommonShort_valueOfWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT CommonShort *CommonShort_valueOfWithNSString_(NSString *s);

FOUNDATION_EXPORT CommonShort *CommonShort_valueOfWithShort_(jshort s);
...
FOUNDATION_EXPORT CommonShort *create_CommonShort_initWithNSString_(NSString *s);

FOUNDATION_EXPORT jint CommonShort_hashCodeWithShort_(jshort value);
...
FOUNDATION_EXPORT jlong CommonShort_toUnsignedLongWithShort_(jshort x);

J2OBJC_TYPE_LITERAL_HEADER(CommonShort)
