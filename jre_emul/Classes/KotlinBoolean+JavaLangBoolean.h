...
/*!
 ...
 @since 1.4
 */
+ (CommonBoolean * __nonnull)valueOfWithBoolean:(jboolean)b;
 ...
 */
+ (CommonBoolean * __nonnull)valueOfWithNSString:(NSString *)s;
...
J2OBJC_STATIC_INIT(CommonBoolean)

/*!
 @brief The <code>Boolean</code> object corresponding to the primitive
  value <code>true</code>.
 */
inline CommonBoolean *CommonBoolean_get_TRUE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT CommonBoolean *CommonBoolean_TRUE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonBoolean, TRUE, CommonBoolean *)

/*!
 @brief The <code>Boolean</code> object corresponding to the primitive
  value <code>false</code>.
 */
inline CommonBoolean *CommonBoolean_get_FALSE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT CommonBoolean *CommonBoolean_FALSE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonBoolean, FALSE, CommonBoolean *)
...
FOUNDATION_EXPORT CommonBoolean *CommonBoolean_valueOfWithBoolean_(jboolean b);

FOUNDATION_EXPORT CommonBoolean *CommonBoolean_valueOfWithNSString_(NSString *s);

FOUNDATION_EXPORT NSString *CommonBoolean_toStringWithBoolean_(jboolean b);

FOUNDATION_EXPORT jint CommonBoolean_hashCodeWithBoolean_(jboolean value);

FOUNDATION_EXPORT jboolean CommonBoolean_getBooleanWithNSString_(NSString *name);

FOUNDATION_EXPORT jint CommonBoolean_compareWithBoolean_withBoolean_(jboolean x, jboolean y);

FOUNDATION_EXPORT jboolean CommonBoolean_logicalAndWithBoolean_withBoolean_(jboolean a, jboolean b);

FOUNDATION_EXPORT jboolean CommonBoolean_logicalOrWithBoolean_withBoolean_(jboolean a, jboolean b);

FOUNDATION_EXPORT jboolean CommonBoolean_logicalXorWithBoolean_withBoolean_(jboolean a, jboolean b);

J2OBJC_TYPE_LITERAL_HEADER(CommonBoolean)
