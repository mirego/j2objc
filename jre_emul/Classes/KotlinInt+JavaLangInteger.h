 ...
 */
+ (CommonInt * __nonnull)decodeWithNSString:(NSString *)nm;
...
/*!
 ...
 @since 1.5
 */
+ (CommonInt * __nonnull)valueOfWithInt:(jint)i;
...
J2OBJC_STATIC_INIT(CommonInt)

/*!
 @brief A constant holding the minimum value an <code>int</code> can
  have, -2<sup>31</sup>.
 */
inline jint CommonInt_get_MIN_VALUE(void);
#define CommonInt_MIN_VALUE ((jint) 0x80000000)
J2OBJC_STATIC_FIELD_CONSTANT(CommonInt, MIN_VALUE, jint)

/*!
 @brief A constant holding the maximum value an <code>int</code> can
  have, 2<sup>31</sup>-1.
 */
inline jint CommonInt_get_MAX_VALUE(void);
#define CommonInt_MAX_VALUE 2147483647
...
FOUNDATION_EXPORT IOSClass *CommonInt_TYPE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonInt, TYPE, IOSClass *)

inline IOSIntArray *CommonInt_get_sizeTable(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT IOSIntArray *CommonInt_sizeTable;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonInt, sizeTable, IOSIntArray *)
...
/*!
 ...
 @since 1.5
 */
inline jint CommonInt_get_SIZE(void);
#define CommonInt_SIZE 32
...
/*!
 ...
 @since 1.8
 */
inline jint CommonInt_get_BYTES(void);
#define CommonInt_BYTES 4
J2OBJC_STATIC_FIELD_CONSTANT(CommonInt, BYTES, jint)

FOUNDATION_EXPORT NSString *CommonInt_toStringWithInt_withInt_(jint i, jint radix);

FOUNDATION_EXPORT NSString *CommonInt_toUnsignedStringWithInt_withInt_(jint i, jint radix);

FOUNDATION_EXPORT NSString *CommonInt_toHexStringWithInt_(jint i);

FOUNDATION_EXPORT NSString *CommonInt_toOctalStringWithInt_(jint i);

FOUNDATION_EXPORT NSString *CommonInt_toBinaryStringWithInt_(jint i);

FOUNDATION_EXPORT NSString *CommonInt_toStringWithInt_(jint i);

FOUNDATION_EXPORT NSString *CommonInt_toUnsignedStringWithInt_(jint i);

FOUNDATION_EXPORT void CommonInt_getCharsWithInt_withInt_withCharArray_(jint i, jint index, IOSCharArray *buf);

FOUNDATION_EXPORT jint CommonInt_stringSizeWithInt_(jint x);
...
FOUNDATION_EXPORT CommonInt *CommonInt_valueOfWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT CommonInt *CommonInt_valueOfWithNSString_(NSString *s);
...
FOUNDATION_EXPORT CommonInt *create_CommonInt_initWithNSString_(NSString *s);

FOUNDATION_EXPORT jint CommonInt_hashCodeWithInt_(jint value);

FOUNDATION_EXPORT CommonInt *CommonInt_getIntegerWithNSString_(NSString *nm);

FOUNDATION_EXPORT CommonInt *CommonInt_getIntegerWithNSString_withInt_(NSString *nm, jint val);

FOUNDATION_EXPORT CommonInt *CommonInt_getIntegerWithNSString_withCommonInt_(NSString *nm, CommonInt *val);

FOUNDATION_EXPORT CommonInt *CommonInt_decodeWithNSString_(NSString *nm);

FOUNDATION_EXPORT jint CommonInt_compareWithInt_withInt_(jint x, jint y);

FOUNDATION_EXPORT jint CommonInt_compareUnsignedWithInt_withInt_(jint x, jint y);

FOUNDATION_EXPORT jlong CommonInt_toUnsignedLongWithInt_(jint x);

FOUNDATION_EXPORT jint CommonInt_divideUnsignedWithInt_withInt_(jint dividend, jint divisor);

FOUNDATION_EXPORT jint CommonInt_remainderUnsignedWithInt_withInt_(jint dividend, jint divisor);

FOUNDATION_EXPORT jint CommonInt_highestOneBitWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_lowestOneBitWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_numberOfLeadingZerosWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_numberOfTrailingZerosWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_bitCountWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_rotateLeftWithInt_withInt_(jint i, jint distance);

FOUNDATION_EXPORT jint CommonInt_rotateRightWithInt_withInt_(jint i, jint distance);

FOUNDATION_EXPORT jint CommonInt_reverseWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_signumWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_reverseBytesWithInt_(jint i);

FOUNDATION_EXPORT jint CommonInt_sumWithInt_withInt_(jint a, jint b);

FOUNDATION_EXPORT jint CommonInt_maxWithInt_withInt_(jint a, jint b);

FOUNDATION_EXPORT jint CommonInt_minWithInt_withInt_(jint a, jint b);

J2OBJC_TYPE_LITERAL_HEADER(CommonInt)

BOXED_INC_AND_DEC(Int, intValue, CommonInt)
BOXED_COMPOUND_ASSIGN_ARITHMETIC(Int, intValue, jint, CommonInt)
BOXED_COMPOUND_ASSIGN_MOD(Int, intValue, jint, CommonInt)
