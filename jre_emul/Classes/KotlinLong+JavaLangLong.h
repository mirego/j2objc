...
/*!
 ...
 @since 1.2
 */
+ (CommonLong * __nonnull)decodeWithNSString:(NSString *)nm;
...
/*!
 ...
 @since 1.5
 */
+ (CommonLong * __nonnull)valueOfWithLong:(jlong)l;
...
J2OBJC_STATIC_INIT(CommonLong)

/*!
 @brief A constant holding the minimum value a <code>long</code> can
  have, -2<sup>63</sup>.
 */
inline jlong CommonLong_get_MIN_VALUE(void);
#define CommonLong_MIN_VALUE ((jlong) 0x8000000000000000LL)
J2OBJC_STATIC_FIELD_CONSTANT(CommonLong, MIN_VALUE, jlong)

/*!
 @brief A constant holding the maximum value a <code>long</code> can
  have, 2<sup>63</sup>-1.
 */
inline jlong CommonLong_get_MAX_VALUE(void);
#define CommonLong_MAX_VALUE 9223372036854775807LL
...
FOUNDATION_EXPORT IOSClass *CommonLong_TYPE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CommonLong, TYPE, IOSClass *)
...
/*!
 ...
 @since 1.5
 */
inline jint CommonLong_get_SIZE(void);
#define CommonLong_SIZE 64
J2OBJC_STATIC_FIELD_CONSTANT(CommonLong, SIZE, jint)
...
/*!
 ...
 @since 1.8
 */
inline jint CommonLong_get_BYTES(void);
...
FOUNDATION_EXPORT NSString *CommonLong_toHexStringWithLong_(jlong i);

FOUNDATION_EXPORT NSString *CommonLong_toOctalStringWithLong_(jlong i);

FOUNDATION_EXPORT NSString *CommonLong_toBinaryStringWithLong_(jlong i);

FOUNDATION_EXPORT NSString *CommonLong_toStringWithLong_(jlong i);

FOUNDATION_EXPORT NSString *CommonLong_toUnsignedStringWithLong_(jlong i);

FOUNDATION_EXPORT void CommonLong_getCharsWithLong_withInt_withCharArray_(jlong i, jint index, IOSCharArray *buf);

FOUNDATION_EXPORT jint CommonLong_stringSizeWithLong_(jlong x);
...
FOUNDATION_EXPORT CommonLong *CommonLong_valueOfWithNSString_withInt_(NSString *s, jint radix);

FOUNDATION_EXPORT CommonLong *CommonLong_valueOfWithNSString_(NSString *s);

FOUNDATION_EXPORT CommonLong *CommonLong_valueOfWithLong_(jlong l);
...
FOUNDATION_EXPORT CommonLong *create_CommonLong_initWithNSString_(NSString *s);

FOUNDATION_EXPORT jint CommonLong_hashCodeWithLong_(jlong value);

FOUNDATION_EXPORT CommonLong *CommonLong_getLongWithNSString_(NSString *nm);

FOUNDATION_EXPORT CommonLong *CommonLong_getLongWithNSString_withLong_(NSString *nm, jlong val);

FOUNDATION_EXPORT CommonLong *CommonLong_getLongWithNSString_withCommonLong_(NSString *nm, CommonLong *val);

FOUNDATION_EXPORT jint CommonLong_compareWithLong_withLong_(jlong x, jlong y);

FOUNDATION_EXPORT jint CommonLong_compareUnsignedWithLong_withLong_(jlong x, jlong y);

FOUNDATION_EXPORT jlong CommonLong_divideUnsignedWithLong_withLong_(jlong dividend, jlong divisor);

FOUNDATION_EXPORT jlong CommonLong_remainderUnsignedWithLong_withLong_(jlong dividend, jlong divisor);

FOUNDATION_EXPORT jlong CommonLong_highestOneBitWithLong_(jlong i);

FOUNDATION_EXPORT jlong CommonLong_lowestOneBitWithLong_(jlong i);

FOUNDATION_EXPORT jint CommonLong_numberOfLeadingZerosWithLong_(jlong i);

FOUNDATION_EXPORT jint CommonLong_numberOfTrailingZerosWithLong_(jlong i);

FOUNDATION_EXPORT jint CommonLong_bitCountWithLong_(jlong i);

FOUNDATION_EXPORT jlong CommonLong_rotateLeftWithLong_withInt_(jlong i, jint distance);

FOUNDATION_EXPORT jlong CommonLong_rotateRightWithLong_withInt_(jlong i, jint distance);

FOUNDATION_EXPORT jlong CommonLong_reverseWithLong_(jlong i);

FOUNDATION_EXPORT jint CommonLong_signumWithLong_(jlong i);

FOUNDATION_EXPORT jlong CommonLong_reverseBytesWithLong_(jlong i);

FOUNDATION_EXPORT jlong CommonLong_sumWithLong_withLong_(jlong a, jlong b);

FOUNDATION_EXPORT jlong CommonLong_maxWithLong_withLong_(jlong a, jlong b);

FOUNDATION_EXPORT jlong CommonLong_minWithLong_withLong_(jlong a, jlong b);

J2OBJC_TYPE_LITERAL_HEADER(CommonLong)

BOXED_INC_AND_DEC(Long, longLongValue, CommonLong)
BOXED_COMPOUND_ASSIGN_ARITHMETIC(Long, longLongValue, jlong, CommonLong)
BOXED_COMPOUND_ASSIGN_MOD(Long, longLongValue, jlong, CommonLong)
